		...
		<div class="top-menu">
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown dropdown-user">
					<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
					<img alt="" class="img-circle" src="{{url('upload/photo/'.Auth::user()->photo)}}"/>					
					...
					<ul class="dropdown-menu dropdown-menu-default">
						<li>
							<a href="{{url('/profiles/my_profile')}}">
							<i class="icon-user"></i> My Profile </a>
						</li>
						<li>
							<a href="{{url('/profiles/my_calendar')}}">
							<i class="icon-calendar"></i> My Calendar </a>
						</li>
						<li>
							<a href="{{url('/profiles/my_inbox')}}">
							<i class="icon-envelope-open"></i> My Inbox <span class="badge badge-danger">
							3 </span>
							</a>
						</li>
						<li>
							<a href="{{url('/profiles/my_tasks')}}">
...
<div class="page-container">
	...
	<div class="page-sidebar-wrapper">
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" id="sidebar_content">
                ...
                success:function(data){
                    ...
                    for (var i = 0; i < data.length;  i++) {
                    	if (data[i]['parent_id'] == null) {
                    		menu += '<li><a href="'+ data[i]['url'] +'"><i class="icon-basket"></i><span class="title">' + data[i]['menu_name'] +'</span><span class="arrow "></span></a><ul class="sub-menu">';
                    		for (var j =0; j < data.length; j++){
                    			if (data[j]['parent_id'] == data[i]['id']){
                    				menu += '<li><a href="'+ data[j]['url'] +'"><i class="icon-home"></i>' + data[j]['menu_name'] +'</a></li>';
                    			}
                    		}
                    		menu += '</ul></li>';
                    	}
                	}
					$("#sidebar_content").append(menu);

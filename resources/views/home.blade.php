...
@section ('content')
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<input type="button" class="btn btn-primary" value="Back" name="" onclick="window.history.back()">
			<input type="button" class="btn btn-warning" value="Forward" name="" onclick="window.history.forward()">

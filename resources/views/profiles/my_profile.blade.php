					...
					<div class="profile-sidebar">
						...
						<div class="portlet light profile-sidebar-portlet">
							...
							<div class="profile-userpic">
								<img id="zxcv_image" src="{{url('upload/photo/'.Auth::user()->photo)}}" class="img-responsive" alt="">
							</div>
							<!-- END SIDEBAR USERPIC -->
							<!-- SIDEBAR USER TITLE -->
							...
							<div class="profile-userbuttons">
								<button type="button" id="test_btn" class="btn btn-circle green-haze btn-sm">Follow</button>
							...
							<div class="profile-usermenu">
								<ul class="nav">
									...
									<li>
										<a href="{{url('/profiles/my_account')}}">
									...
									<div class="portlet-body">
										...
										<div class="table-scrollable table-scrollable-borderless">
											...
											<tr>
												...
												<td>
													<a href="{{url('phoneNumber')}}" class="primary-link">Brain</a>
												</td>
												<td>
													 $345
												</td>
